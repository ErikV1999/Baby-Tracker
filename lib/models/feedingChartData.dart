...
List<BarChartGroupData> barChartGroupData = [
  ...
  BarChartGroupData(x: 3, barRods: [
    BarChartRodData(
        y: dayArr[2], colors: [Color(0xff43dde6), Color(0xff43dde6)]),
  ]),
  BarChartGroupData(x: 4, barRods: [
    BarChartRodData(
        y: dayArr[3], colors: [Color(0xff43dde6), Color(0xff43dde6)]),
  ]),
  BarChartGroupData(x: 5, barRods: [
    BarChartRodData(
        y: dayArr[4], colors: [Color(0xff43dde6), Color(0xff43dde6)]),
  ]),
  BarChartGroupData(x: 6, barRods: [
    BarChartRodData(
        y: dayArr[5], colors: [Color(0xff43dde6), Color(0xff43dde6)]),
  ]),
  BarChartGroupData(x: 7, barRods: [
    BarChartRodData(
        y: dayArr[6], colors: [Color(0xff43dde6), Color(0xff43dde6)]),
  ]),
];
